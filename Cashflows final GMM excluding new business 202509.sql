...
Where						1 = 1
							...
							--and p.pol_PolicyNumber = 'HTYR000040POL';
...
Where						1 = 1
						...
						and derived.FilterDate NOT BETWEEN '2024-07-01' AND '2025-10-01' ;--Update
...
b.Pol_PolicyNumber,
						...
						--	B.EDisbursements,
							...
							c.AmortizationProportion,
							 CONCAT (
							Case
								When b.CellCaptive = 'Auto Pedigree' Then '01-HPS-IW-WW-AP1-81-WAP'
								When b.CellCaptive = 'CMH' Then '01-HPS-IW-WW-CMH-81-WCM'
								When b.CellCaptive = 'Motus OEM' Then '01-HPS-IW-WW-IMP-81-WIM'
								When b.CellCaptive = 'IEMAS' Then '01-HPS-IW-WW-IET-81-WIE'
								When b.CellCaptive = 'M-Sure Mobility' Then '01-HPS-IW-WW-ELS-81-WEL'
								When b.CellCaptive = 'Master Cell' Then '01-HPS-IW-WW-000-81-W00'
								When b.CellCaptive = 'Kempston Group' Then '01-HPS-IW-WW-KMG-81-WKM'
								When b.CellCaptive = 'Wesbank (WESB)' Then '01-HPS-IW-WW-WPI-81-WW3'
								When b.CellCaptive = 'Maritime Motors' Then '01-HPS-IW-WW-MTM-81-WMT'
								When b.CellCaptive = 'Meyers Group' Then '01-HPS-IW-WW-MEY-81-WME'
								When b.CellCaptive = 'Motus Imports' Then '01-HPS-IW-WW-AMH-81-WAM'
								Else Null
							End , '-',Profitability,'-',CAST(b.groupingyear as varchar(4)))  IFRSGroup
--select *
From						#belra5 b
left join (Select distinct POL_PolicyNumber, CellCaptive, CreateMonth, IRMonth, GroupingYear from #pol2) as t
							on b.POL_PolicyNumber = t.POL_PolicyNumber
