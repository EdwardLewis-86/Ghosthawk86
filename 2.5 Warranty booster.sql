...
SELECT			POL_PolicyNumber [Policy Number]
				,Policy_id [Policy ID]
				,case when pol_productvariantlevel1_id in ('A96B15B6-7922-46BF-93BD-14C735991BB3') THEN 'Wty Booster' 
...
WHERE			POL_Product_ID = Product_Id
				...
				and pol_productvariantlevel1_id in ('A96B15B6-7922-46BF-93BD-14C735991BB3');
