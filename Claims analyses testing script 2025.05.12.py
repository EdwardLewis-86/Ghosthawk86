...
#----------------------- Notes -----------------------
# First run the Policy Claim for anomolies to exclude extreme outliers.
...
# Define output path
output_path = "C:/Users/edwardl/OneDrive - Motus Corporation/Documents/3. RStudio_Python Outputs/Existing Claim Data Analyses"
QQ_output_path = "C:/Users/edwardl/OneDrive - Motus Corporation/Documents/3. RStudio_Python Outputs/Existing Claim Data Analyses/QQ Plots"
...
data_path = "C:/Users/edwardl/OneDrive - Motus Corporation/Documents/2. RStudio_Python Inputs/claims_policy_data.xlsx"
...
claim_periods = np.random.randint(1, months + 1, num_simulations)
vehicle_makes = np.random.choice(claims_inflated_df["Vehicle Make"].dropna().unique(), num_simulations)
simulated_claims = []
